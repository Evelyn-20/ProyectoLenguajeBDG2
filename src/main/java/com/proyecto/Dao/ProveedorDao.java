...
public class ProveedorDao {
    ...
    public List<Proveedor> obtenerProveedoresActivos() {
        String sql = "SELECT * FROM vista_proveedores_activos";
        return jdbcTemplate.query(sql, proveedorRowMapper);
    }

    public List<Proveedor> obtenerProveedoresInactivos() {
        String sql = "SELECT * FROM vista_proveedores_inactivos";
        return jdbcTemplate.query(sql, proveedorRowMapper);
    }
    ...
    // Nueva función para verificar si un proveedor tiene productos asociados
    public boolean proveedorTieneProductos(Long idProveedor) {
        String sql = "SELECT fn_cantidad_productos_por_proveedor(?) FROM dual";
        Integer cantidad = jdbcTemplate.queryForObject(sql, Integer.class, idProveedor);
